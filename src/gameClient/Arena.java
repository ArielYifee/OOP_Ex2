...
public class Arena {
    ...
    public static ArrayList<CL_Pokemon> json2Pokemons(String fs) {
        ...
        try {
            ...
            for (int i = 0; i < ags.length(); i++) {
                ...
                CL_Pokemon f = new CL_Pokemon(Pp, t, v, 0, null);
                ans.add(f);
            }
        } catch (JSONException e) {
            e.printStackTrace();
	...
	private edge_data getEdge(Point3D p, int t){
    	edge_data e = null;
		outerloop:
		for (node_data n : this._gg.getV()) {
			for (edge_data ed : this._gg.getE(n.getKey())) {
				if(isOnEdge(p,ed,t,this._gg)){
					e=ed;
					break outerloop;
				}
			}
...
//	public void setPokemonsE() {
//		List<CL_Pokemon> L = getPokemons();
//		for(CL_Pokemon P: L){
//			outerloop:
//			for (node_data n : this._gg.getV()) {
//				for (edge_data ed : this._gg.getE(n.getKey())) {
//					if(isOnEdge(P.getLocation(), ed,P.getType(),this._gg)){
//						P.set_edge(ed);
//						break outerloop;
//					}
//				}
